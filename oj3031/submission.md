...
```text
รับค่าระยะต่อวินาทีที่น้ำหมึกแผ่ขยายตัวออกไป และ หาว่าจะท่วมบ้านของแต่ละคนในกี่วินาที
```
...
```text
รับความเร้วที่น้ำหมึกจะขยายตัวแผ่ออกไปต่อวินาที และ จำนวนบ้าน
วนลูปรับค่าทุกบ้าน ตามจำนวนn
เอาไปคำนวณตามสูตร
วนลูปออกมาเปนคำตอบตามจำนวนบ้าน n 
```
...
```text
ใช้ตามวิธีที่คิด 
เพียงแค่เปลี่ยนจากค่า pi ที่โจทย์กำหนดมาให้
```
