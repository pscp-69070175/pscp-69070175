...
```text
รับค่าคะแนนทั้งหมดของคน3คน และคะนนสูงสุด จากนั้นหาว่าค่ามากสุดกับต่ำสุดห่างกันเกิน2หรือไม่
```
...
```text
เริ่มรับค่าก่อน
หาวิธ๊การเพื่อหาคะแนนต่ำสุด
นำมาลบกับคะแนนสูงสุดแล้วดูว่าเกิน2ไหม
หาเกินก้ให้เป็นsurprise vote
```
...
```text
เลือกใช้วิหธีหาค่าน้อยสุดด้วยการ ค่าทั้งหมด ลบออกด้วยค่ามากสุดสองครั้งโดยสมมุติว่าค่าสองตัวเป็นค่ามากสุด
