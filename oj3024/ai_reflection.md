...
| OJ submission ID, if submitted | 3024 |
| OJ status | Pass |
...
```text
ให้ai ช่วยแนะเรื่องการหาคะแนนต่ำสุด จากการที่โจทย์ให้มาแค่คะแนนทั้งหมดกับคะแนนสูงสุด
```
...
```text
AI ช่วยให้สังเกตว่าถ้าต้ิองการหาคะแนนที่ต่ำสุด ควรเริ่มจากสังเกตจากข้อมูลที่โจทย์ให้มาโดยดูจากค่ามากสุดที่ให้มา
```
...
```text
ทดลองเอาค่ามากสุดลบออกก่อนแล้วทดลองลบอีกครั้งโดยเดาคะแนนขึ้นมาเอง ทดลองจาก 29 10  โดยเอา10ลบออกสองครั้งแล้วตัวสุดท้ายก้จะเท่ากับ9
```
...
```text
การลองสังเกตข้อมูลที่ได้มาและทดลองโดยใช้ความคิดแปลกใหม่
```
