...
```text
รับค่าวันและเดือนมา จากนั้นตอบว่ายุในฦดูกาลอะไร
```
...
```text
เริ่มสร้างลิสต์เพื่อกำหนดฦดู
เช็คว่าวันที่ตรงกับ21มั้ย และเดือนอยู่ในเดือนที่3หารลงตัวไหม
ใช้การบวกindexไปอีกก่อนเพื่อให้เดือนฦดูกาลเปนอันถัดไปเมื่อตรงเงื่อนไข
```
...
```text
ได้เปลี่ยนการใช้ +index เมื่อตรงเงื่อนไข เนื่องจากออกมาพิดผลาดและไม่ตรงกับเทสเคส โดยเอาindex เป็นตัวแปร
```
...
```text
ทดสอบการเปลี่ยนฦดูตอนตรงเงื่อนไข
```
...
```text
ช่วยแนะเรื่องวิธีเพิ่มindex +1
```

คุณยังทำอะไรด้วยตนเอง

```text
โครงสร้างโจทย์ทั้งหมดนอกจากตรงส่วนนี้
```
