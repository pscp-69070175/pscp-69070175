...
```text
รับอิฐเล้กอิดใหญ่ คำนวณจำนวนอิฐ  ถ้าอิฐเล็ก ไม่เกินจำนวนที่มี  แสดงจำนวนอิฐเล็กถ้ามีอิฐเล็กไม่พอ แสดง -1
```
...
รับจำนวนอิฐ สะพาน
คำนวณจำนวนอิฐใหญ่
หาความยาวที่เหลือหลังใช้อิฐใหญ่
แสดงผลคำตอบขึ้นอยู่กับจำนวนอิฐเล้ก
```
