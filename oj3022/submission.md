...
```text
รับค่าองศา หน่วยตั้งต้น หน่วยที่แปลงเป็น จากนั้นคืนค่าออกมาเป็นหน่วยที่แปลงแล้ว
```
...
```text
รับค่าทาก่อน
แปลงค่ามาเป็นเชลเชียส
เอาค่าเซลเซียสมาแปลงเปนค่าอื่น
คืนค่าคำตอบบออกมาโดยเปนทศนิยม2ตำแหน่ง
```
...
```text
ใช้ตามวิธีตั้งต้น เพราะวิธีที่ถุกต้องและทำได้ไม่ซับซ้อนมาก
```
