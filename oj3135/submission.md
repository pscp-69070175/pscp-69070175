...
```text
รับค่ามาเปนจำนวนคน ตำแหน่งโจร จำนวนครั้งที่เื่อนตำแหน่ง
ค่าออกมาเปนจำนวนครั้งที่ส่งต่อกล่องของขวัญ
```
...
```text
เช็คว่าค่าตำแหน่งโจร = ตำแหน่งแรกไหม ถ้าใช่ก้ตัดจบเลย
กำหนดคค่าตำหน่งเมื่อวนครับจำนวน n ให้เริ่มใหม่
วนลูปจนกว่าจะได้ตำแหน่งของฏจรจึงค่อยหยุด
...
```text
เปลี่ยนใช้วิธีทีี่สั่นลงนิดหน่อย
```
