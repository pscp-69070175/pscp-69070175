...
```text
จับคู่การผสมแม่สีของแดง,เหลือง,น้ำเงิน โดยรับชื่อสี2ชื่อและออกมาเป็นสีที่ผสมกันแล้ว
```
...
```text
ทำความเข้าใจการผสมสีก่อน
เริ่มแยกการผสมสีแต่ละตัว
เช็คว่าสีไหนสีแรก แล้วผสมกับสีที่สอง
```
...
```text
พลาดหลายครั้งในการเช็คเทสเคสต์เช่นการหากว่าเปนสีเดียวกัน และพลาดสุดที่ทำให้ติดโจทย์นี้นานคือ purpleเผลอใช้แทนที่จะเป็นviolet 
```
