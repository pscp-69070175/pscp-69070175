...
```text
รับค่าnเปนตำแหน่งแรกของจุดเริ่มต้น จากนั้นเอาไปคำนวณหาการที่จะปถึงห้องที่1 และระบุจำนวนน้อยที่สุดทีต้องพังกำแพงไปห้แงที่1
```
...
```text
รับตำแหน่งห้องจุดเริ่มเข้ามา
หาว่าอยู่แถวไหน 
หาว่าอยู่ห้องไหนของแถว
คำนวณการขยับพังกำแพงจากจุดเริ่มต้นไปจุดที่1
```
...
```text
ใช้ตามแผนแรกเพียงแค่เติมกรณีว่าถ้าจุดเริ่มต้นคือ 1 ให้ตอบเลยว่า 0 
```
...
```text
ทดสอบว่าสูตรหลัก ทำงานถูกต้องใหม
```
