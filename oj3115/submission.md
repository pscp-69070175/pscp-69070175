...
```text
รับจำนวนร้าน ช่วงเวลาที่ต้องตรวจ รับเวลาปิดและเปิด รับเวลาที่ต้องการตรวจ
ออกมาเป็นจำนวนร้านที่ยังเปิด
```
...
```text
รับจำนวนร้าน จำนวนเวลา
เก็บเวลาเปิด ปิด
รับเวลาที่ต้องการตรวจสอบ
ตรวจสอบทุกร้านด้วยเงื่อนไข
พิมออกมาในบรรทัดเดียว
```
...
```text
ใช้ตามที่คิดไว้แก้ไขนิดหน่อยจากการบั้กรันไม่ไ้ดเรื่อง เวลาที่ออกมาไม่ตรง
```
...
```text
ตรวจเวลาที่ตรงกับเวลาเปิดและเวลาปิด
```
