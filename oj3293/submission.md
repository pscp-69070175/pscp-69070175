...
```text
จทย์ให้รับข้อความ 5 บรรทัด แล้วนำข้อความทั้งหมดมาใส่ในกรอบสี่เหลี่ยม โดยให้ข้อความที่สั้นกว่าบรรทัดที่ยาวที่สุดเติมช่องว่างให้เท่ากัน
```
...
หาแถวที่มีความยาวมากที่สุด
สร้างความกว้างของกรอบจากข้อความที่ยาวที่สุด
เติมช่องว่างให้ข้อความทุกบรรทัดยาวเท่ากัน
แสดงกรอบด้านบน ข้อความ และกรอบด้านล่าง
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก หา string ที่ยาวที่สุดก่อน แล้วใช้ความยาวนั้นกำหนดขนาดกรอบ ]tเติมช่องว่างให้แต่ละบรรทัดเท่ากันก่อนแสดงผล
```
