...
```text
รับตัวอักษรมาแล้วนับว่ามีสระตัวไหนกี่ตัว
```
...
รับคำ
นับจำนวนสระ
รวจสอบว่ามีสระตัวนั้นหรือไม่ ถ้ามีให้แสดงจำนวนที่นับได้
```
...
```text
ตัวพิมพ์เล็กและตัวพิมพ์ใหญ่ปนกัน
```
