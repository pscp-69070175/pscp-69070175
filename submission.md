...
```text
โจทย์ให้รับ L คือความหนาของแถบ และ N คือจำนวนช่องที่ปลูก ต้องหาว่าช่องที่ปลูกเป็นช่องสุดท้ายอยู่ในแถบที่เท่าไร 
แสดงคำตอบคือ หมายเลขแถบที่ช่องสุดท้ายอยู่
```
...
```text
รับค่า L และ N
เริ่มนับจำนวนช่องที่ปลูกและหมายเลขแถบ
คำนวณจำนวนช่องของแต่ละแถบ
บวกจำนวนช่องที่ปลูกไปเรื่อย ๆ
ถ้าจำนวนช่องรวมถึง N ให้แสดงหมายเลขแถบนั้น
```
...
```text
ใช้ while เพื่อเพิ่มแถบทีละแถบ และคำนวณจำนวนช่องของแต่ละแถบ แล้วไปบวกกับจำนวนช่องที่ปลูกจนกว่าจะถึง N แล้วแสดงหมายเลขแถบสุดท้าย
```
