...
```text
โจทย์ให้รับค่าสี RGB ของสี 2 สี แล้วหาค่าเฉลี่ยของ R, G และ B เพื่อสร้างสีใหม่
```
...
```text
รับค่า R G B ของสีที่ 1
รับค่า R G B ของสีที่ 2
หาค่าเฉลี่ย
แสดงค่า R G B ที่ได้
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก นำค่าสีแต่ละช่องของสีทั้งสองมาบวกกันแล้วหาร 2 จากนั้นแสดงค่า R, G และ B ที่ได้
```
