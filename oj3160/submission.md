...
```text
รับค่าจำนวนแรกถึงท้าย
เอาไปหาจำนวนเฉพาะ  ที่อยู่ในระยะ และหาจำนวนทั้งหมดที่เจอ
...
```text
รับค่า ระยะ
หาจำนวนเฉพาะ ด้วยการวนลูป
เอาไปใส่ในลิสต์จากนั้นส่งค่าออกมา เปน จำนวนทั้งหมด
```
...
```text
ใช้ตามวิธีแรกแค่เปลี่ยนวิธีการหาจำนวนเฉพาะที่รันผ่านทุกเทสเคส
```
