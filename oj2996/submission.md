...
```text
รับค่าตัวอักษรมา5ตัว สับเปลี่ยนจากหน้าเปนหลังตามลำดับ และ ให้ออกมาเปนพิมพ์เล็กทั้งหมด
```
...
```text
หาวิธีที่จะทำให้ออกมาแค่5ตัวอักษร ใช่สตริงสไลซิ่ง
ทำให้ตัวอักษรเปนตัวเล็ก
หาวิธีที่ทำให้ตัวอักษรออกมาสลับ ใช้::-1
```
...
```text
ตามวิธีที่คิดไว้ โดยลองตรวจหลายครั้งเพื่อกะนความผิดพลาดไว้ แล้วผลออกมาผ่านฉลุย
```
...
```text
ถ้าไม่ใส่ไรเลยจะเปนยังไง errorไหม
```
