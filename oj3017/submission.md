...
```text
รับอินพุตเป็นค่าอาหารและเครื่องดื่ม โดยให้เอาต์พุต คือ ค่าอาหาร+vat+ค่าบริการ  สำคัญของข้อนี้คือการคิดค่าบริการที่มีเงื่อนไข
```
...
```text
เริ่มเขียนสิ่งที่โจทย์ต้ิิงดารก่อน เริ่มาจาก:
รับค่าอาหารก่อน
เอาไปคำนวณหาค่าบริการ
เช็คว่าค่าบริการอยู่ในจำนวนน้อยกว่า50หรือมากกว่า1000
หาค่าvat โดยเอาค่าอาหารรวมกับบริการ
เอาไปค่าอาหาร + ค่าบริการ + ค่าvat
ปริ้นคำตอบโดยให้เปนทศนิยม2ตำแหน่ง(ตามที่โจทย์ต้องการ
```
...
```text
ใช้เหมือนแผนแรก เพราะโครงสร้างถุกต้องตามที่ต้องการรันแล้วคำตอบออกมาตรง
```
...
```text
เพราะทดสอบหากเปนติดลบจะเป็นยังไง
```
