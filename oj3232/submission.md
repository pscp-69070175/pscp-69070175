...
```text
โจทย์ให้รับระยะกระโดดครั้งแรก X และระยะเป้าหมาย Y โดยทุกครั้งที่กระโดด ระยะจะลดลง 2 เมตร ต้องหาจำนวนครั้งที่กระโดดแล้วระยะรวมถึง Y ถ้าไม่ถึงให้แสดง -1
```
...
```text
รับค่ากระโดด กับเปา้หมาย
 ลดระยะกระโดดลง 2
 ถ้า y เหลือ 0 หรือน้อยกว่า ให้แสดงจำนวนครั้ง
ถ้าระยะกระโดดลดจนเหลือ 0 หรือน้อยกว่า ให้แสดง -1
```
