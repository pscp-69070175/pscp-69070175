...
```text
รับค่ามาแล้วหาว่าระหว่าง n ถึง 0 มีจำนวนไหนหารด้วยๅจลงตัวได้
```
...
```text
สร้างลิสต์ขึ้นมา
รับค่า n จากนั้นวนลูปหาร10 ว่ามีจำนวนไหนหารลงตัวบ้างถ้าลงตัว
ให้ใส่เข้าไปในลิสต์
จากนั้นแสดงค่าที่หารลงตัวออกมาทั้งหมด
ตัด"ที่ติดมากับลิสต์ด้วยjoin 
```
...
```text
ใช้วิธีตามที่คิด เพราะลองทดสอบรันได้ถูกต้องตรงที่คิดไว้
```
